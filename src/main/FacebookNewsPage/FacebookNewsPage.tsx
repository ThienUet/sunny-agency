...
const news = [
  ...
  {
    area: 'Meta news',
    title: 'Meta Agency First Awards 2023 - Reels, AI, and brand advertising are the three key factors that will help brands reach new heights in 2024',
    date: 'about a month ago',
  ...
  {
    area: 'Meta news',
    title: 'Meta Hong Kong & Singapore Financial Forum 2023: Building Full Funnel Marketing Strategies',
    date: 'about a month ago',
  ...
  {
    area: 'Meta news',
    title: 'Maximizing Meta Video Ads for Short & Long Term Impact in Asia Pacific',
    date: 'May 2023',
  ...
  {
    area: 'Asia',
    title: 'Analysis: Big Tech fires first salvo against Malaysia’s licensing regime, but faces tricky next steps',
    date: 'about a month ago',
  ...
  {
    area: 'Asia',
    title: 'Analysis: The Anwar government’s growing push against Big Tech raises questions of its true intentions',
    date: 'about a month ago',
          ...
          <div className={styles.wrap_content}>
                  ...
                  <a key={index} href={item.url} target="_blank">
                    <div className={styles.wrap_news_item}>
                      <div style={{ height: 120}}>
                        <div className={styles.wrap_news_image} style={{ width: 200, height: 120 }}>
                          <img src={item.image} style={{ objectFit: 'cover', height: '100%' }}/>
                        </div>
                      </div>
                      <div>
            ...
            <div className={styles.wrap_about_meta}>
              <div style={{ position: 'sticky', top: 0 }}>
                <img src='/images/news/meta.jpg'/>
                <img src='images/news/facebook.png' style={{ borderRadius: '12px' }} />
                <div className={styles.sun_agency_introduce}>
                  Sunny Agency is your trusted partner in Facebook advertising, committed to delivering affordable, reliable, and high-quality services. We specialize in crafting targeted ad campaigns that maximize your reach while minimizing costs, ensuring your brand gets the attention it deserves.
                </div>    
              </div>
            </div>
          </div>
