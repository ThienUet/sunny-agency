      ...
      <div className={styles.review_page_content}>
        ...
        <div className={styles.wrap_overall}>
          <div className={styles.overall_item}>
            ...
            <div className={styles.overall_comment}>Growth in reviews on this year</div>
          </div>
          ...
          <div className={styles.overall_item}>
            ...
            <div className={styles.overall_comment}>Avarage rating on this year</div>
          </div>
              ...
              <div className={styles.review_item}>
                <div className={styles.user}>
                  ...
                  <div className={styles.user_info}>
                    ...
                    <div className={styles.user_props}>
                      Total Review:&nbsp;<div className={styles.user_value}>{item.review}</div>
                    </div>
                  </div>
                </div>
